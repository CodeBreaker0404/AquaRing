...
function ThreeViewerVR({ plyUrl }) {
  const containerRef = useRef();

  useEffect(() => {
    // Start gesture control when VR view is loaded
    ...
    return () => {
      // Stop gesture control when VR view is closed
